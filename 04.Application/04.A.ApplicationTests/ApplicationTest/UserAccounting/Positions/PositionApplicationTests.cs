...
namespace ApplicationTest.UserAccounting.Positions
{
    public class PositionApplicationTests : BaseTestWithSetMapper
    {
        ...
        //        public PositionApplicationTests() : base(new AutoMapperConfiguration())
        //        {
        ...
        //            sut = new PositionApplicationService(new UnitOfWork(dbContext), new AutoMapperConfiguration());
        //        }
        ...
        public PositionApplicationTests(IAutoMapperConfiguration config) : base(config)
        {
        }
    }
}
